      ...
      if(m_mouse_flags==MOUSE_INVALID_FLAGS)
        {
         ...
         if(!IS_ACTIVE)
           {
            //--- generate event
            EventChartCustom(INTERNAL_EVENT,ON_MOUSE_FOCUS_SET,m_id,0.0,m_name);
            //--- activate
            return(Activate());
           }
         return(true);
      ...
      if((m_mouse_flags&MOUSE_LEFT)!=0)
        {
         ...
         if(IS_CLICKS_BY_PRESS)
           {
            EventChartCustom(INTERNAL_EVENT,ON_CLICK,m_id,0.0,m_name);
            //--- handled
            return(true);
           }
        }
...
bool CWnd::BringToTop(void)
  {
//--- generate event
   EventChartCustom(INTERNAL_EVENT,ON_BRING_TO_TOP,m_id,0.0,m_name);
//--- handled
   return(true);
  }
//+------------------------------------------------------------------+
...
bool CWnd::OnDblClick(void)
  {
//--- send notification
   EventChartCustom(INTERNAL_EVENT,ON_DBL_CLICK,m_id,0.0,m_name);
//--- handled
   return(true);
  }
//+------------------------------------------------------------------+
...
//--- save
   ...
   m_mouse_y=y;
//--- generate event
   EventChartCustom(INTERNAL_EVENT,ON_DRAG_PROCESS,m_id,0.0,m_name);
//--- handled
   return(true);
  }
//+------------------------------------------------------------------+
