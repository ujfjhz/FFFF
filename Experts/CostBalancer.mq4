...
extern string stratedy="trend";//交易策略。有如下选择：trend,inertia.默认为trend:按趋势交易；inertia为惯性策略。
string cbVersion="0.95(1142)";//version
...
int start()
  {
   ...
   //---- go  only for first tiks of new bar
   if(Volume[0]>1)
   {
      return;
   }
